...
public class DistanceQueries {
    ...
    static void solve() {
        ...
        for(int i = 0; i < q; i++){
            ...
            long ans = depth[a] + depth[b] - 2L * depth[l];
    ...
    static void dfs(int node1, int parent1, List<List<Integer>> tree, int[] depth, int[][] up){
    ...
    static int lca(int u, int v, int[][] up, int[] depth){
